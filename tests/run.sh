#!/usr/bin/env bash
# Test entrypoint for cloche-pro-workstation. See tests/README.md for what
# this covers and how to run it locally/in CI.
...
IMAGE="${1:-cloche-pro-workstation-test}"
BUILD_METHOD="bluebuild"
RECIPE="./recipes/cloche-pro-workstation-plasma.yml"

# --- Gap 1: KDE skel files ---
...
# --- Gap 2: dynamic KDE wallpaper (structure only) ---
...
# --- Gap 3: GNOME CustomTransparent shell theme ---
...
# --- Gap 4: rpm-repo package connection ---
...
# --- Gap 6: boot-speed systemd masks ---
...
# --- Gap 7: plasma-discover exclusion pair ---
...
main() {
    ...
    echo ""
    echo "=== Gap 2: dynamic wallpaper (structure only, not rendering) ==="
